<%@ Page meta:resourcekey="Page" Language="C#" MasterPageFile="~/PracticaMaD.Master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_BodyContent" runat="server">
    <div id="form">
        ...
        <asp:Label ID="LblSubtotal" runat="server" CssClass="label" Text=" Subtotal =" Font-Bold="True" />
        <asp:Label ID="Subtotal" runat="server" text-align="center" />
        <br />
        <br />
